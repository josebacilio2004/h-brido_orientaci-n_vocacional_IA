    ...
    <div class="glass-card rounded-xl p-6">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between p-4 bg-white rounded-lg border border-gray-200">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <p class="font-medium text-gray-900">{{ $result->vocationalTest->title }}</p>
                            <p class="text-sm text-gray-500">Completado el {{ $result->created_at->format('d/m/Y') }}</p>
                        </div>
                    </div>
                    <div class="flex items-center space-x-2">
                        <span class="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full">Completado</span>
                        <a href="{{ route('tests.result', $result->id) }}" class="text-indigo-600 hover:text-indigo-800 text-sm font-medium">Ver Resultados</a>
                    </div>
                </div>
                @endforeach
            </div>
        @else
            <div class="text-center py-8">
                ...
                <p class="mt-1 text-sm text-gray-500">Comienza tu primer test vocacional para descubrir tu carrera ideal.</p>
                <div class="mt-6">

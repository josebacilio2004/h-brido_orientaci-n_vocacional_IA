    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20 hover:border-purple-400 transition-all hover:transform hover:scale-105">
                ...
                @if(in_array($test->id, $completedTests))
                <a href="{{ route('tests.result', $test->id) }}" 
                   class="block w-full text-center bg-white/20 text-white px-4 py-2 rounded-lg font-semibold hover:bg-white/30 transition-all">
                    Ver Resultados
                </a>
                @else
                <a href="{{ route('tests.show', $test->id) }}" 
                   class="block w-full text-center bg-gradient-to-r from-purple-600 to-pink-600 text-white px-4 py-2 rounded-lg font-semibold hover:from-purple-700 hover:to-pink-700 transition-all">
                    Comenzar Test
                </a>
                @endif
            </div>
            ...
            <div class="col-span-full text-center py-12">
                ...
                <p class="text-gray-400 text-lg">No hay tests disponibles. Ejecuta el seeder para crear el test vocacional.</p>

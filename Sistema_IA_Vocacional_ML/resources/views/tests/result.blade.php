    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-6">
        <div class="max-w-5xl mx-auto">
            ...
            <div class="text-center mb-8">
                <div
                    class="mx-auto h-24 w-24 bg-gradient-to-br from-green-500 to-emerald-600 rounded-full flex items-center justify-center mb-4 animate-bounce">
                    ...
                    @foreach ($result->recommended_careers as $index => $recommendation)
                        <div class="bg-white/5 rounded-xl p-6 border border-white/10">
                            <div class="flex items-center gap-3 mb-4">
                                <div
                                    class="bg-gradient-to-br from-purple-500 to-pink-500 text-white w-10 h-10 rounded-full flex items-center justify-center font-bold">
                                    {{ $index + 1 }}
                                </div>
                                <div>
            ...
            <div class="flex gap-4">
                ...
                <a href="{{ route('tests.restart', $result->vocational_test_id) }}"
                    class="flex-1 bg-red-600 text-white px-6 py-4 rounded-lg font-semibold hover:bg-red-700 transition-all text-center">
                    Reiniciar Test
                </a>

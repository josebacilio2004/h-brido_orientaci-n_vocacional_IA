    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20 mb-6">
            <div class="flex items-center justify-between mb-6">
                <a href="{{ route('tests.index') }}" class="text-gray-300 hover:text-white flex items-center gap-2 transition-colors">
            ...
            <div class="text-center">
                <div class="mx-auto h-20 w-20 bg-gradient-to-br from-purple-500 to-pink-600 rounded-full flex items-center justify-center mb-4">
        ...
        <div class="bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20 text-center">
            ...
            <p class="text-gray-300 mb-6">El test se guardará automáticamente después de cada pregunta. Puedes pausar y continuar cuando quieras.</p>
